#   Scenario: The break statement is used to exit/terminate a loop.
...
#   message "You've successfully left the loop." should be printed to the screen, and the 
...
#not a good excerise as while loop automatically breaks if the condition is not true